...
const schedule = {
  ...
  day2: [
    { time: "10:00 AM onwards", title: "Jugaad", venue: "Audi Foyer", logo: "/jugaad-Cwv8sXek.webp" },
    { time: "11:00 AM", title: "Hult Prize", venue: "MAC", logo: "/hultprize-CoQqOHCs.webp" },
    { time: "11:00 AM onwards", title: "Startup Expo", venue: "ECE Lawns", logo: "/expo-BuSr9Ws3.webp" },
    { time: "7:00 PM - 10:00 PM", title: "Founders Talk", venue: "Auditorium", logo: null },
  ],
  day3: [
    { time: "10:30 AM - 4:30 PM", title: "Escape Room", venue: "CRC", logo: "/escaperoom-CL_1DC28.webp" },
    { time: "10:00 AM", title: "IPL Auction", venue: "Library Lawn", logo: "/iplauction-CM6tDsO9.webp" },
    { time: "7:00 PM - 10:00 PM", title: "Consonite", venue: "Auditorium", logo: null },
    { time: "10:00 AM - 1:00 PM", title: "CEO (R-2)", venue: "Conference Hall", logo: "/ceo-CiTAFyd_.webp" },
    { time: "11:00 AM onwards", title: "Startup Conclave", venue: "MAC", logo: "/suc-Bc2Eb1A0.webp" },
    { time: "4:00 PM - 6:00 PM", title: "Valedictory", venue: "MAC", logo: null },
  ],
};
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative flex flex-col gap-16">
            ...
            {events.map((event, index) => {
              ...
              const card = (
                <div className="group relative bg-black/60 backdrop-blur-xl border border-red-500/40 
